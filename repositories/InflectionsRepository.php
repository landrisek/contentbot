...
final class InflectionsModel {
    ...
    public function __construct() {
        ...
        /** děvče  (če,dě,tě,ně,pě) výj.-také sele */
        ...
        /** Amadeus, Celsius, Kumulus, rektikulum, praktikum */
        ...
        /**  zbroj, výzbroj, výstroj, trofej, neteř, jiří, podkoní, ... ? */
        ...
        /**  umlauts  důl ... dol, stůl ... stol, nůž ... nož, hůl ... hole, půl ... půle, náhrada */
        $nv1 = 0;
        $this->v1 = Array();
        ...
        $this->v10[$nv10++] = "noe";
        $this->v10[$nv10++] = "Noe";
        /** $this->v10 change to woman genus  */
        $this->v11 = Array();
        $nv11 = 0;
        $this->v11[$nv11++] = "vš";
        $this->v11[$nv11++] = "dešť";
        ...
        /** $this->v12 change to medium genus  */
        /**  "transmise"; */
        $this->v12 = Array();
        $nv12 = 0;
    ...
    /** return String if match suffix or word, other -1 */
    private function match($vz, $txt) {
    ...
    /** transformations ďi,ťi,ňi,ďe,ťe,ňe ... di,ti,ni,dě,tě,ně + "ch" -> "#" */
    ...
    /** transformations: di,ti,ni,dě,tě,ně ... ďi,ťi,ňi,ďe,ťe,ňe */
    ...
    private function Sklon($nPad, $vzndx, $txt, $zivotne = false) {
        ...
        $kndx = $this->match($this->vzor[$vzndx][1], $txt3);
    ...
    public function inflect($text, $zivotne = false, $preferovanyRod = '') {
        ...
        $out['kin'] = $this->PrefRod;
        return $this->addFall($out);
    }
    ...
    private function StdNdx($slovo) {
        for ($iii = 0; $iii < count($this->vzor); $iii++) {
            ...
            if ($this->match($this->vzor[$iii][1], $slovo) >= 0)
                break;
        }
    ...
    private function addFall($input) {

        for($i=1;$i<15;$i++) {
            isset($input[$i]) ? $input[$i] = trim($input[$i]) : $input[$i] = '';
        }
        $result['kin'] = $input['kin'];
        $result['sN'] = $input[1];
        $result['sG'] = $input[2];
        $result['sD'] = $input[3];
        $result['sA'] = $input[4];
